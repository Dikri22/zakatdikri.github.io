...
<div class="container-fluid p-2" style="background-color: #95d5b2"><h3 style="font-weight: bold; padding-left: 15px;">LAPORAN BAYAR ZAKAT</h3> </div>
<div class="container-fluid p-4 shadow mb-5" style="padding-bottom: 20px; padding-top: 20px;">
  <button type="button" class="btn btn-danger float-end" onclick="location.href='export.php'">PRINT</button><br><br>
...
<div class="container-fluid p-2" style="background-color: #95d5b2"><h3 style="font-weight: bold; padding-left: 15px;">LAPORAN DISTRIBUSI WARGA</h3> </div>
<div class="container-fluid p-4 shadow mb-5" style="padding-bottom: 20px; padding-top: 20px;">
  <button type="button" class="btn btn-danger float-end" onclick="location.href='export_warga.php'">PRINT</button><br><br>
...
<div class="container-fluid p-2" style="background-color: #95d5b2"><h3 style="font-weight: bold; padding-left: 15px;">LAPORAN DISTRIBUSI MUSTAHIK</h3> </div>
<div class="container-fluid p-4 shadow mb-5" style="padding-bottom: 20px; padding-top: 20px;">
  <button type="button" class="btn btn-danger float-end" onclick="location.href='export_mustahik.php'">PRINT</button><br><br>
