...
<div class="container-fluid p-2" style="background-color: #95d5b2"><h3 style="font-weight: bold; padding-left: 15px;">DATA MUZAKKI</h3> </div>
  ...
  <table id="tabel_muzakki" class="table table-striped ">
        <thead style=" color: black; font-size: 1.1em;" >
          <tr class="text-center">
             ...
             <th class="text-center">ID MUZAKKI</th>
...
<div class="modal fade" id="myModalTambah">
                <div class="modal-dialog">
                    ...
                    <div class="modal-header">
                        <h4 class="modal-title">Tambah Data Muzakki</h4>
                    ...
                    <div class="modal-body">
                        <input type="text" name="muzakki" class="form-control mt-2" placeholder="Nama Muzakki" required >
                        <input type="number" name="jumlahtanggungan" class="form-control mt-2" placeholder="Jumlah Tanggungan" required>
                        <select name="keterangan" class="form-control mt-2" placeholder="Keterangan">
                    ...
                    <div class="modal-footer">
                        <button type="submit" class="btn btn-success" name="tambahmuzakki">Simpan</button>
...
<!-- The Modal edit -->
                                            ...
                                            <div class="modal-dialog">
                                                ...
                                                <input type="text" name="editidmuzakki" class="form-control mb-2" placeholder="Nama Muzakki" value="<?=$id;?>" readonly>
                                                <div style="font-weight: bold;">
                                                    Nama Muzakki
                                                    </div>
                                                    <input type="text" name="muzakki" class="form-control mb-2" placeholder="Nama Muzakki" value="<?=$muzakki;?>" required >
                                                    <div style="font-weight: bold;">
                                                    Jumlah Tanggungan
                                                    </div>
                                                    <input type="number" name="jt" class="form-control mb-2" placeholder="Jumlah Tanggungan" value="<?=$jt;?>" required>
                                                    <div style="font-weight: bold;">
                                                    Keterangan
                                                    </div>
                                                    <select name="keterangan" class="form-control" placeholder="Keterangan" value="<?=$keterangan;?>" required>
                                                ...
                                                <!-- Modal footer -->
                                                <div class="modal-footer">
                                                    <button type="submit" class="btn btn-success" name="editmuzakki">Edit</button>
                                                    <button type="button" class="btn btn-danger" data-bs-dismiss="modal">Kembali</button>
                                                </div>
                                        ...
                                        <div class="modal-dialog">
                                            ...
                                            <input type="hidden" name="idmuzakki1" value="<?=$id;?>">
                                            </div>
