...
<div class="container-fluid p-2" style="background-color: #95d5b2"><h3 style="font-weight: bold; padding-left: 15px;">DATA DISTRIBUSI MUSTAHIK</h3> </div>
        ...
        <tbody style="color: black; font-size: 1.1em;">
         <?php 
                        ...
                        <td class="text-center">
                          <button type="button" class="btn btn btn-primary btn-sm" data-bs-toggle="modal" data-bs-target="#edit<?=$idmustahiklainnya;?>">Edit</button> | 
                          <button type="button" class="btn btn-danger btn-sm" data-bs-toggle="modal" data-bs-target="#delete<?=$idmustahiklainnya;?>">Hapus</button>
                        </td>
                        </tr>
